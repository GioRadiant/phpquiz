    ...
    public $UserRecord = "Please wait DB connection.";
        ...
        public function getResult($UserID)
        {
            ...
            if (($result = $NewBdConnection->myconn->query("
                ...
                $VoteResult = "<p> Dear <b>".$_SESSION['UserName']."</b>, thanks for playing with us!</p><p>You replied correctly to <b>".$Vote." questions out of ".$f."</b>. Your vote is: <b>".round((($Vote/$f)*100), 1)."%</b>";
            } else {
                $VoteResult="noresult";
            }
...
<meta name="description" property="og:description" content="php/JS Quiz, you will just need to insert you name, and select a quiz from the list. (the number of question is shown). Advertise Me ltd php/js Quiz, coded by Giorgio Lombardi">
<meta property="og:type" content="website">
<meta property="og:title" content="Advertise Me ltd php/js Quiz">
<meta property="og:image" content="images/Advertise_Me_ltd_quiz.jpg">
<meta property="og:site_name" content="Advertise Me ltd test Quiz">
<title>Advertise Me ltd test Quiz</title>
<link rel="stylesheet" href="styles/quiz.css">
<link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
<link rel="icon" href="images/favicon.ico" type="image/x-icon">
</head>
<body>
<ul id="topbar"><li class="leftalign"><h1 id="TitleTopBar">Advertise Me ltd test Quiz</h1></li><li class="rightalign"><img src="images/Advertise_Me_ltd_quiz.jpg" alt="Advertise Me ltd php/js Quiz"></li></ul>
...
<div class="footer">
  <p>Advertise Me ltd, 2018 - PHP&JS sample quiz by Giorgio Lombardi.</p>
</div>
</body>
</html>
';
...
';
   //end of assign Base HTML code
    ...
    $html = '
    <p> Welcome to this php/JS Quiz, you will just need to insert you name, and select a quiz from the list. (the number of question is shown).</p>
    <div class="am-col m6"><input type="text" id="UserName" placeholder="Your Name"></input></div><div class="am-col m6">
    ';
    $html.=$quizDropDown;
    $html.="</div><div class='am-col m12 centerAlign'><button id='submitForm' class='submit' onclick='SubmitUserData();'>start</button><p id='msgBOX' visibility='hidden'></p><progress value='0' max='100' id='progressBar'></progress><p id='ProgressInfo'>step 0</p></div>";
    }
...
echo $htmlStart.$html.$scriptBlock.$htmlEnd;
    ...
    if ($quizQuestion==="noresult"){
        $errorFlag=1;
            ...
            echo "<p>Just click onto the answer box to chose one. At the end of the quiz you will have your score and position in the scorelist.</p>"
            .$quizQuestion."<div class='am-col m12 centerAlign'><p id='msgBOX' visibility='hidden'></p><progress value='".(($_SESSION['SessionPage']/$_SESSION['NumOfQuest'])*100)."' max='100' id='progressBar'></progress><p  id='ProgressInfo'>step ".$_SESSION['SessionPage']." out of ".$_SESSION['NumOfQuest']."</p></div>";    
        }
    }
} else if ($_SESSION['SessionPage']>1) {
    ...
    session_destroy();
        ...
        echo $quizQuestion."<div class='am-col m12 centerAlign'><p id='msgBOX' visibility='hidden'></p><progress value='".(($_SESSION['SessionPage']/$_SESSION['NumOfQuest'])*100)."' max='100' id='progressBar'></progress><p id='ProgressInfo'>step ".$_SESSION['SessionPage']." out of ".$_SESSION['NumOfQuest']."</p></div>";
        }
      }
    }
 }
